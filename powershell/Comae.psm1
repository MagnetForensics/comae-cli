...
Function Send-ComaeDumpFile(
    ...
    [Parameter(Mandatory = $True)] [string] $ItemType="File",
    ...
    )
{
 ...
 Export-ModuleMember -Function Get-ComaeCases, Get-ComaeOrganizations, Invoke-ComaeADWinAnalyze, Invoke-ComaeAwsVMWinAnalyze, Invoke-ComaeAzVMWinAnalyze, Send-ComaeDumpFile, New-ComaeDumpFile, Get-ComaeToolkitPath